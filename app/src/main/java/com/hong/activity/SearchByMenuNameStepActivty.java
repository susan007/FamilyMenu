...
import com.hong.adapter.MenuStepAdapter;
...
public class SearchByMenuNameStepActivty extends Activity {
	...
	private void setStepListView() {
		MenuStepAdapter adapter=new MenuStepAdapter(SearchByMenuNameStepActivty.this,
				getListViewData(), 
