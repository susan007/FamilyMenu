...
public class CardPagerAdapter extends PagerAdapter implements CardAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(container.getContext())
                .inflate(R.layout.splash_cardview, container, false);
    ...
    private void bind(CardItem item, View view) {
        ...
        TextView contentTextView = (TextView) view.findViewById(R.id.menu_detail);
        ImageView menuImg=(ImageView)view.findViewById(R.id.menu_img) ;
        titleTextView.setText(item.getTitle());
        contentTextView.setText(item.getText());
        menuImg.setImageResource(item.getMenuImg());
    }
